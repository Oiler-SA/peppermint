...
const type = [
  { id: 5, name: "Enova365" },
  { id: 1, name: "Sieć" },
  { id: 3, name: "Zgłaszanie pomysłów" },
  { id: 4, name: "Problem z komputerem" },
  { id: 6, name: "Dostęp do danych" },
  { id: 9, name: "Feedback" },
  { id: 8, name: "Urządzenia peryferyjne" },
  { id: 10, name: "Incydenty bezpieczeństwa" },
  { id: 11, name: "Zapotrzebowanie na sprzęt" },
  { id: 12, name: "Problem z telefonem" },
  { id: 13, name: "Problem z pocztą" },
  { id: 2, name: "Inne" },
];
